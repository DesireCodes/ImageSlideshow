package com.desirecodes.imageslider
...
import com.desirecodes.imageslider.animations.*
import com.desirecodes.imageslider.blurkit.BlurLayout
...
class ImageSlider @JvmOverloads constructor(
    ...
    private var blurView: BlurLayout? = null
    ...
    init {
        ...
        cornerRadius =
            typedArray.getDimension(R.styleable.ImageSlider_iss_corner_radius, 1.0F).toInt()
        ...
        showBlurView = typedArray.getBoolean(R.styleable.ImageSlider_iss_show_blur_view, false)
        ...
        if (showBlurView) {
            ...
            blurView?.cornerRadius = cornerRadius.toFloat()
        } else {
