...
import com.desirecodes.imageslider.R;
...
public class BlurLayout extends FrameLayout {
    ...
    public BlurLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                com.desirecodes.imageslider.R.styleable.ImageSlider,
                0, 0);

        try {
            mDownscaleFactor = a.getFloat(R.styleable.ImageSlider_blk_downscaleFactor, DEFAULT_DOWNSCALE_FACTOR);
            mBlurRadius = a.getInteger(R.styleable.ImageSlider_blk_blurRadius, DEFAULT_BLUR_RADIUS);
            mFPS = a.getInteger(R.styleable.ImageSlider_blk_fps, DEFAULT_FPS);
            mCornerRadius = a.getDimension(R.styleable.ImageSlider_blk_cornerRadius, DEFAULT_CORNER_RADIUS);
            mAlpha = a.getDimension(R.styleable.ImageSlider_blk_alpha, DEFAULT_ALPHA);
        } finally {
            a.recycle();
        }
